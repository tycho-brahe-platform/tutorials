...
![Criação novo corpus](./images/cc/criacao_corpus.png)

1. Adicione um nome ao novo corpus e clique em "Confirmar": esta ação finaliza a criação do corpus (Note que estas ações apenas criam o corpus. Para inclusão/edição de documentos, ou seja, alimentar o corpus ver Caso de uso 03.2). Esta ação cria um novo corpus, que aparecerá na lista.

![Criação corpus: inserir nome](./images/cc/criacao_corpus_nome.png)
...
![Acesso área reservada](./images/cc/acesso_area_reservada.png)
...
![Acesso rápido](./images/cc/acesso_rapido_admin.png)
...
![](./images/cc/tycho_admin_3.png)

Este atalho redireciona para o Visualizador:

![](./images/cc/tycho_admin_4.png)
...
![](./images/cc/tycho_admin_11.png)

![](./images/cc/tycho_admin_11_2.png)
...
![](./images/cc/tycho_admin_12.png)

![](./images/cc/tycho_admin_13_14.png)
...
![](./images/cc/tycho_admin_16.png)

###### GitHub <!--REVISAR: vai ser necessário ter uma reunião com o Luiz para vermos como tudo se conecta com relação ao Git-->
...
![](./images/cc/admin_description_1.png)
...
![](./images/cc/admin_otherdetails_1.png)
...
![](./images/cc/param_corpus_4.png)

**Use Sound**: a habilita o suporte a áudio no corpus.
![](./images/cc/param_corpus_5.png)
...
![Configuração de corpora: botão "Use Sound"](./images/cc/botao_config_corpus_usesound.png)
...
- O **"Use Sound"** também habilita, na ferramenta "eDictor", um botão de _play_ para tocar os áudios associados às sentenças do documento selecionado, como observamos na figura abaixo:
  ![Configuração de corpora: botão "Use Sound" 2](./images/cc/botao_config_corpus_usesound2.png)

**Use Translations**: o botão "Use Translations" habilita a seção de Traduções no eDictor, como apresentado na figura a seguir:

![](./images/cc/param_corpus_6.png)

![Configura corpus: Use Translations](./images/cc/botao_config_corpus_usetranslation.png)
...
![](./images/cc/param_corpus_10.png)

![Configuração corpus_ Use Category](./images/cc/botao_config_corpus_usecategory.png)

**Use Edition Tiers**<!--[REVISAR COM O LUIS]-->: este botão habilita a disponibilização de diversos níveis de edição para garantir a máxima fidelidade filológica do texto.

![](./images/cc/param_corpus_11.png)
...
![Configura corpus: Use edition tiers](./images/cc/botao_config_corpus_useeditiontiers1.png)

![Configura corpus: botão Use Edition Tiers 2](./images/cc/botao_config_corpus_useeditiontiers2.png)

![Configura corpus: botao Use Edition Tiers 4](./images/cc/botao_config_corpus_useeditiontiers3_4.png)
...
![Matriz para edição: edition tiers](./images/cc/botao_config_corpus_useeditiontiers5.png)
...
![](./images/cc/param_corpus_12.png)

![Use eDictor Translations](./images/cc/botao_config_corpus_useedictortranslations1.png)
...
![Apresentação das traduções no eDictor Translations](./images/cc/configura_corpus_admin_translations3_1.png)

![](./images/cc/admin_use_edct_translation_1.png)
...
![](./images/cc/param_corpus_18.png)

![](./images/cc/atrib_import_chat_1.png)
...
![](./images/cc/tycho_admin_32_33.png)
...
4.  Clique em "Create". Um painel para preenchimento das informações do metadado se abre.
    ![](./images/cc/tycho_admin_34_35.png)
    ...
    3. **Values:** este campo faz sentido ser preenchido somente se o tipo selecionado para o metadado por "List". Ao adicionar o metadado do tipo lista, o usuário consegue adicionar valores para esta lista, que serão disponibilizados para seleção no catálogo. Por exemplo: metadado: Estados de Nascimento; tipo: LIST; values: MG,SP,PR:
       ![](./images/cc/tycho_admin_38_39.png)
...
![Acesso config parâmetors fluxo altern](./images/cc/configura_parametro_FA1.png)
