...
3. Na página de perfil que se abre, os corpora disponíveis, vinculados ao usuário, são apresentados. Selecione o corpus que deseja configurar e clique no botão "eDictor" na área de "Acesso rápido" ou "eDictor" na área "Minhas Ferramentas" e selecione o corpus que deseja configurar.
   !["Selecionando o eDictor"](../images/pt_br/acesso_rapido_edictor.png)
...
4. Com o catálogo aberto, clique sobre o nome do corpus e como em [1] para abrir a lista suspensa com os corpora disponíveis e selecione o corpus que deseja editar [2], como na Figura:
   !["Selecionando um corpus no catálogo"](../images/pt_br/edictor_selecionando_corpus.png)
...
5. Após selecionar o corpus que deseja editar, acesse "Exibir informações" clicando no ícone com menu (menu com seis pontos) no documento do corpus.
   !["Acessando "Exibir informações"](../images/pt_br/edict_trans_exibir_info.png)
...
6. Na aba de "Ações" , na menu que abre à esquerda, no campo "Continuar a edição do documento", clique na seta para abrir o menu de ferramentas de edição: selecionar o "eDictor Translations" (Nota: o botão de configuração de parâmetros "Use eDictor Translations" deve estar habilitado para habilitar a edição através do **eDictor Translations**).
   !["Abrir edição com "eDictor Translations""](../images/pt_br/exib_info_selecionando_ferramentas_edicao.png)
...
!["Inserir sentenças"](../images/pt_br/edictor_trans_acoes_edicao.png)

!["Apagar sentenças"](../images/pt_br/edict_trans_sentencas_sincronizadas_inseridas.png)

   3. Editar sentenças sincronizadas:
      1. Via botão E - eDictor:
         1. Com o corpus já selecionado, selecione um par de sentenças.!["Seleciona sentença"](../images/pt_br/edictor_edicao_sent_sincronizadas4.png)</br></br>
         2. Selecione botão E (eDictor).!["seleciona E"](../images/pt_br/edictor_edicao_sent_sincronizadas5.png)</br></br>
         ...
         4. Para editar a tradução: role a página até o campo de "Traduções", edite o campo com o texto e salve.!["editando texto"](../images/pt_br/edictor_edicao_sent_sincronizadas6.png)</br></br>
         5. Para outras edições da palavra: clique em "...":
            1. Clique em "inserir": inserir palavra á direita da palavra selecionada, preencha o campo e confirme!["edições palavra"](../images/pt_br/edictor_edicao_sent_sincronizadas7.png)</br></br>
            2. Clique em "dividir": dividir palavra em dois tokens distintos![""](../images/pt_br/edictor_edicao_sent_sincronizadas8-9.png)</br></br>
            3. Clique em "unir" para unir o token selecionado ao token seguinte na sentença: ![""](../images/pt_br/edictor_edicao_sent_sincronizadas10.png)
            ...
            5. Clique em "remover": remover palavra.![""](../images/pt_br/edictor_edicao_sent_sincronizadas11.png)</br></br>
         ...
         ![Erro união sentença](../images/pt_br/edictor_erro_unir_sentenca.png)
      2. Via botão UD:
         1. Com o corpus já selecionado, selecione um par de sentenças.!["Seleciona sentença"](../images/pt_br/edictor_edicao_sent_sincronizadas4.png)</br></br>
         2. Selecione botão UD (Dependências Universais).![""](../images/pt_br/edictor_edicao_sent_sincronizadas12.png)</br></br>
         3. Para editar o original: no quadro, na linha da palavra desejada clique no ícone de lápis (edição) da palavra que desejar, edite a palavra e confirma.![""](../images/pt_br/edictor_edicao_sent_sincronizadas13.png)</br></br>
         4. Não há edição de tradução com o botão UD selecionado
         5. Para incluir palavra: na linha da palavra selecionada, clique em "+", preencha o campo com a palavra a ser adicionada e confirme.![""](../images/pt_br/edictor_edicao_sent_sincronizadas14.png)</br></br>
         6. Para aplicar informações de um token a todos tokens similares do documento: na linha da palavra selecionada, clique no ícone de "cópia".![""](../images/pt_br/edictor_edicao_sent_sincronizadas15.png)</br></br>
         7. Para deletar: na linha da palavra, clique no ícone com "lixeira" e confirme.![""](../images/pt_br/edictor_edicao_sent_sincronizadas16.png)</br></br>
   4. Remover sentenças sincronizadas:
      1. Selecionar um par de sentenças.
      2. Clicar em no ícone de "lixeira" (remover) e confirmar.![""](../images/pt_br/edictor_edicao_sent_sincronizadas17.png)
...
1. Acesse a página de catálogo através do link: <https://www.tycho.iel.unicamp.br/catalog> :
   ...
   ![""](../images/pt_br/edictor_edicao_sent_sincronizadas18.png)
...
3. Uma caixa de diaĺogo se abre: clique em "confirmar".
   ...
   ![""](../images/pt_br/edictor_adicionar_sentença_1.png)
...
6. Clique em "adicionar nova sentença".
   ...
   ![""](../images/pt_br/edictor_adicionar_sentença_2.png)

Sentença e tradução adicionadas:

   ![alt](../images/pt_br/edictor_adicionar_sentença_3.png)
